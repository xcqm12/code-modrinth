...
// i18n symbols that should be imported from @Bbsmc/ui
...
const VALID_IMPORT_SOURCES = ['@Bbsmc/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @Bbsmc/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@Bbsmc/ui\''))
		console.log()
	}
