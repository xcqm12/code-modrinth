<template>
	...
	>
		...
		>
			...
			>
				<Avatar src="https://cdn-raw.bbsmc.org.cn/medal_icon.webp" size="64px" class="opacity-50" />
				<SpinnerIcon
					v-if="isUpgrading"
			...
			<Avatar v-else src="https://cdn-raw.bbsmc.org.cn/medal_icon.webp" size="64px" class="z-10" />
