		...
		files: [
			{
				...
				url: 'https://cdn.bbsmc.org.cn/data/story/version-1.jar',
		...
		files: [
			{
				...
				url: 'https://cdn.bbsmc.org.cn/data/story/version-2.jar',
			...
			},
			{
				...
				url: 'https://cdn.bbsmc.org.cn/data/story/version-2-sources.jar',
		...
		files: [
			{
				...
				url: 'https://cdn.bbsmc.org.cn/data/story/version-3.mrpack',
...
const meta = {
	...
	args: {
		...
		versionLink: (version: Version) => `https://bbsmc.org.cn/mod/sodium/version/${version.id}`,
	},
	render: (args) => ({
