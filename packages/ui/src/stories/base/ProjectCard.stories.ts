...
export const Default: Story = {
	args: {
		...
		layout: 'grid',
		title: 'Example Mod',
		author: { name: 'Prospector', link: 'https://bbsmc.org.cn/user/Prospector' },
		summary:
...
export const ServerProject: Story = {
	args: {
		...
		serverModpackContent: {
			...
			icon: 'https://cdn.bbsmc.org.cn/data/AANobbMI/icon.png',
				...
				<div>
					...
					<div class="display-mode--grid">
						<ProjectCard
							...
							:tags="['technology', 'magic']"
							:environment="{ clientSide: 'required', serverSide: 'optional' }"
							banner="https://cdn.bbsmc.org.cn/data/AANobbMI/images/be1cc1abc9cd9c2f52bb6a39be0b4b05af24d813.png"
						/>
					</div>
				</div>
			</div>
