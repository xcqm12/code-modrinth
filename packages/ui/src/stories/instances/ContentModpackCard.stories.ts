...
const fabulouslyOptimizedProject: ContentModpackCardProject = {
	...
	icon_url:
		'https://cdn.bbsmc.org.cn/data/1KVo5zza/9f1ded4949c2a9db5ca382d3bcc912c7245486b4_96.webp',
	description:
...
const cobblemonProject: ContentModpackCardProject = {
	...
	icon_url: 'https://cdn.bbsmc.org.cn/data/5FFgwNNP/e7f9ee2e9d361623847853fe2ddce42f519ee64f.png',
...
const simplyOptimizedProject: ContentModpackCardProject = {
	...
	icon_url: 'https://cdn.bbsmc.org.cn/data/BYfVnHa7/845e93223da7e8d1ed1a33364b5bdb4c316ac518.png',
	description:
...
const userOwner: ContentOwner = {
	id: '2avTeeAE',
	name: 'robotkoer',
	avatar_url: 'https://cdn.bbsmc.org.cn/user/2avTeeAE/icon.png',
	type: 'user',
}
...
const cobblemonOwner: ContentOwner = {
	...
	name: 'Reisen',
	avatar_url:
		'https://cdn.bbsmc.org.cn/user/AEFONbAM/9e97453507a8245981d5cd825280f23be44f15ac.jpeg',
	type: 'user',
}
			...
			const modpackContent = [
				...
				},
				{
					project: {
						...
						title: 'Mod Menu',
						icon_url:
							'https://cdn.bbsmc.org.cn/data/mOgUt4GM/5a20ed1450a0e1e79a1fe04e61bb4e5878bf1d20.png',
					},
