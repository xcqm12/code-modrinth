...
- Fixed issue where when browsing content for your server panel, when visiting a project page and going back to search, it would reset the page back to one.`,
	},
	{
		...
		product: 'web',
		body: `## Changed
- Changed review estimate text from 24�?8 hours to within a week, to set more realistic expectations for now.`,
	},
	{
...
- Fixed flickering on page headers at a specific window size.`,
	},
	{
		...
		version: '0.16.0',
		body: `## Added
- Added shared instances. You can now easily share your instances with your friends - [see the blog post here for more information.](https://bbsmc.org.cn/news/article/shared-instances)
...
- Added support for the [Ears](https://bbsmc.org.cn/mod/ears) mod in the Skin selector.
...
- Backups now correctly show the user who created them.`,
	},
	{
		...
		product: 'hosting',
		body: `## Added
- You can now share access to the server panel through the Access tab. For more information [see the blogpost here](https://bbsmc.org.cn/news/article/server-access/).`,
	},
	{
...
- Fixed failing to fetch analytics for an obscene amount of projects.`,
	},
	{
		...
		product: 'web',
		body: `## Changed
- Completely overhauled project analytics. See our [blog post](https://bbsmc.org.cn/news/article/analytics-overhaul/) to learn about it!
...
- Redesigned the server panel header �?loader, game version, server address, uptime, and linked project are now shown as clean inline stats with the project icon and a link to the project page, matching instances in the Bbsmc App.
...
- Fixed a bug with server onboarding/reset flow not passing the correct NeoForge loader version for the selected game version.`,
	},
	{
		...
		version: '0.12.5',
		body: `## Added
- Added a Files tab for instances, matching the Bbsmc Hosting experience �?browse, edit, and manage all files in your instance folder without leaving the app, ideal for editing config files, viewing crash reports, and more.
...
- Added limits for creating content on Bbsmc
	...
	- If you need more, please contact [support](https://support.bbsmc.org.cn) and explain why, and we can increase your limits.`,
	},
	{
		date: `2025-09-29T12:50:00-07:00`,
		product: 'app',
...
- Resolved CPU usage readings that previously exceeded 100% during high-load scenarios. CPU usage is now accurately normalized to a 0�?00% range across all cores.
