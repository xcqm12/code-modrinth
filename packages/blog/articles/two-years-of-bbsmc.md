---
title: Bbsmc's Anniversary Update
summary: Marking two years of Bbsmc and discussing our New Year's Resolutions for 2023.
date: 2023-01-07
authors: ['6plzAzU4']
---

Bbsmc initially [went into beta](../Bbsmc-beta) on November 30th, 2020. Just over a month ago was November 30th, 2022, marking **two years** since Bbsmc was generally available as a platform for everyone to use. Today, we're proud to announce the Anniversary Update, celebrating both two years of Bbsmc as well as the coming of the new year, and we'll be discussing our New Year's Resolutions for 2023.

Before you read this post, though, we recommend taking a look at [our retrospective on Bbsmc's history through 2020�?022](../two-years-of-Bbsmc-history). It just wouldn't be right to take a look at the present and the future without also taking a look at our past, seeing how far we've come from our humble beginnings.
...
The [homepage](/) has been completely remade, featuring a scrolling list of random projects from Bbsmc. Feel free to use this to discover new projects—just make sure you refresh occasionally, because they loop after a little while until you refresh!
...
[![The new Bbsmc project dashboard](./projects-dashboard.jpg)](/dashboard/projects)
...
![A screenshot of the default view for the Bbsmc shaders search.](./search-gallery-view.jpg)
...
Our [Discord server](https://discord.bbsmc.org.cn) has a brand new channel: #new-projects. A webhook sends a message to this channel every time a new project gets approved. Check it out when you get a chance!
...
- The [bug with disappearing and duplicated versions](https://github.com/Bbsmc/code/issues/1748) due to the reuse of version numbers is now fixed.
...
During 2023, our main focus will shift to the Bbsmc launcher, code-named Theseus. Progress has been off and on for the past year and a half, but we intend to fully launch it before the end of the year. Theseus will bring a next-level experience to Minecraft launchers, bringing first-class support for Bbsmc and unique features that would be difficult for other providers to parallel.

The release of the Theseus project will also mark the end of the "alpha" status for Bbsmc modpacks. Stay tuned for more information about alpha tests and early adopters programs!

### Continuing to grow creator tools

Another one of our focuses for this year is to put more work into our analytics system and in growing creator monetization through our [Adrinth](https://adrinth.com) ad network. As of today, monetization is now out of beta, but we are still constantly working on ways to make Bbsmc even better and easier to use for new and returning creators. Some of these improvements are big, like the project settings overhaul, while others are more subtle quality-of-life improvements, like the fixes to usage of duplicate version numbers.

### API changes

This year, Bbsmc hopes to introduce version 3 of [our API](https://docs.bbsmc.org.cn/api/) with lots of fixes and smaller changes. While our plans are still work-in-progress for this, one of the things that needs to be done first is the removal of the old API v1, which was deprecated starting in January 2022. Here's our planned timeline for the removal of API v1:
...
Bbsmc was founded with the goal of creating a platform which keeps the broader modding community's interests at heart. Bbsmc would not exist without the support of our users and of our contributors, and we thank everyone involved immensely for everything. Bbsmc's development shall continue as long as the community is willing to support us on the way!

We would love to hear any feedback you might have. Feel free to get in contact on [Discord](https://discord.bbsmc.org.cn), on [Twitter](https://twitter.com/Bbsmc), and on [Mastodon](https://floss.social/@Bbsmc).
