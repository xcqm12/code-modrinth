...
Pride is a time for celebration, self-expression, and community. Queer individuals are part of Bbsmc at every level: across our team, our creator community, and the wider Minecraft community as a whole. We're very proud to be vocal in our support for LGBTQIA+ rights all year round.
...
That's why this Pride Month, Bbsmc will be running a fundraiser supporting [**Rainbow Railroad**](https://www.rainbowrailroad.org/).
...
<a href="https://bbsmc.org.cn/pride?from=blog-2026" class="!text-2xl font-semibold">You can support the fundraiser here.</a>

**When donating, please enter your _Bbsmc username_ as the _Tiltify display name_ so we can apply any eligible rewards to your account!**

## Donation Matching Commitment

We want to maximize the impact our community can make.

To help achieve this, Bbsmc is matching all donations 1:1, up to $10,000! We will apply matched donations at the end of the event.
...
Everyone who donates will receive a special Pride 2026 profile badge on Bbsmc.

<img width="204px" height="204px" class="mx-auto mb-4" src="/news/article/pride-campaign-2026/pride-badge.webp" />

Supporters with this badge will also unlock a special Pride section in the Skin selector in the Bbsmc App featuring the incredibly cute Mr. Pack in Pride-themed, exclusive Bbsmc skins:

![Mr. Pack Pride skins](./mrpack-pride-banner.webp)

### Bbsmc+

Donations of $5 (USD) or more will grant you with free [Bbsmc+](https://bbsmc.org.cn/plus) benefits for 1 month as an additional thank-you - available to users who do not already have an active Bbsmc+ subscription.

## Pride Collection 2026

Alongside the fundraiser, we're also launching the [Bbsmc Pride Collection!](https://bbsmc.org.cn/collection/M4c3ITvd)

This collection highlights projects made by and for the queer community, including mods, resource packs, modpacks, plugins, and more across Bbsmc.

[**You can submit projects all month long**](https://tally.so/r/GxQBbO)

Throughout June, we'll be featuring selected projects from the collection across our social media alongside our usual creator spotlights. Pride is about visibility, and we want to use this month to celebrate the LGBTQIA+ creators and communities that help make Bbsmc what it is.
