...
![A graph of many Bbsmc projects and their page views, showing a relatively even distribution across countries.](./country-page-views.jpg)

Upon further investigation, there was one specific launcher that was repeatedly downloading the same files from Bbsmc over and over again within a very short time span.
...
This, to say the least, baffled us. We already had code called [Sisyphus](https://github.com/Bbsmc/sisyphus) in place to limit the number of downloads that a single source can make over a given span of time. So what gives?
...
1. A source (whether this be a launcher, someone clicking the download button on the website, etc.) would request a file from Bbsmc.
...
To reiterate, the issue is now resolved and **payouts were not affected**. Payouts do not take into account downloads from launchers other than the [Bbsmc App](/app); therefore, this adjustment has no bearing on payouts.

P.S. Are you curious about why our download counter is called Sisyphus? In Greek mythology, Sisyphus rolls a boulder up a hill for the rest of eternity. Like Sisyphus, our download counter has no point other than to keep increasing for as long as Bbsmc exists.
