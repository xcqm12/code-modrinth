...
export function flattenStaticVariables(): Record<string, string> {
	...
	vars[`LICENSING_GUIDE`] =
		`our guide to [Licensing your Mods](https://bbsmc.org.cn/news/article/licensing-guide)`
	vars[`NEW_ENVIRONMENTS_LINK`] = `https://bbsmc.org.cn/news/article/new-environments`
	vars[`LEARN_MORE_ABOUT_SERVERS_FLINK`] =
		`[learn more about server projects from our news feed](https://bbsmc.org.cn/news/article/introducing-server-projects/)`
	vars[`SHARED_INSTANCES_FLINK`] =
		`[Shared Instances](https://bbsmc.org.cn/news/article/shared-instances/)`
...
export function flattenProjectVariables(
	...
	vars[`PROJECT_PERMANENT_LINK`] = `https://bbsmc.org.cn/project/${project.id}`
	vars[`PROJECT_SETTINGS_LINK`] = `https://bbsmc.org.cn/project/${project.id}/settings`
	vars[`PROJECT_SETTINGS_FLINK`] = `[Settings](https://bbsmc.org.cn/project/${project.id}/settings)`
	vars[`PROJECT_TITLE_FLINK`] = `[Name](https://bbsmc.org.cn/project/${project.id}/settings)`
	vars[`PROJECT_SLUG_FLINK`] = `[URL](https://bbsmc.org.cn/project/${project.id}/settings)`
	vars[`PROJECT_SUMMARY_FLINK`] = `[Summary](https://bbsmc.org.cn/project/${project.id}/settings)`
	vars[`PROJECT_ENVIRONMENT_FLINK`] =
		`[Environment Information](https://bbsmc.org.cn/project/${project.id}/settings/environment)` // Depreciated
	vars[`PROJECT_TAGS_LINK`] = `https://bbsmc.org.cn/project/${project.id}/settings/tags`
	vars[`PROJECT_TAGS_FLINK`] = `[Tags](https://bbsmc.org.cn/project/${project.id}/settings/tags)`
	vars[`PROJECT_DESCRIPTION_LINK`] =
		`https://bbsmc.org.cn/project/${project.id}/settings/description`
	vars[`PROJECT_DESCRIPTION_FLINK`] =
		`[Description](https://bbsmc.org.cn/project/${project.id}/settings/description)`
	vars[`PROJECT_LICENSE_LINK`] = `https://bbsmc.org.cn/project/${project.id}/settings/license`
	vars[`PROJECT_LICENSE_FLINK`] =
		`[License](https://bbsmc.org.cn/project/${project.id}/settings/license)`
	vars[`PROJECT_LINKS_LINK`] = `https://bbsmc.org.cn/project/${project.id}/settings/links`
	vars[`PROJECT_LINKS_FLINK`] =
		`[External Links](https://bbsmc.org.cn/project/${project.id}/settings/links)`
	vars[`PROJECT_GALLERY_LINK`] = `https://bbsmc.org.cn/project/${project.id}/gallery`
	vars[`PROJECT_GALLERY_FLINK`] =
		`[Gallery](https://bbsmc.org.cn/project/${project.id}/settings/gallery)`
	vars[`PROJECT_VERSIONS_LINK`] = `https://bbsmc.org.cn/project/${project.id}/versions`
	vars[`PROJECT_VERSIONS_FLINK`] =
		`[Versions](https://bbsmc.org.cn/project/${project.id}/settings/versions)`
	vars[`PROJECT_MODERATION_LINK`] = `https://bbsmc.org.cn/project/${project.id}/moderation`
	vars[`PROJECT_MODERATION_FLINK`] =
		`[moderation tab](https://bbsmc.org.cn/project/${project.id}/moderation)`
	vars[`PROJECT_SERVER_SETTINGS`] = `https://bbsmc.org.cn/project/${project.id}/settings/server`
	vars[`PROJECT_SERVER_SETTINGS_FLINK`] =
		`[Server Settings](https://bbsmc.org.cn/project/${project.id}/settings/server)`
	vars[`PROJECT_LANGUAGE_SETTINGS`] = `https://bbsmc.org.cn/project/${project.id}/settings/server`
	vars[`PROJECT_LANGUAGE_SETTINGS_FLINK`] =
		`[Language Settings](https://bbsmc.org.cn/project/${project.id}/settings/server)`
	vars[`PROJECT_PERMISSIONS_LINK`] =
		`https://bbsmc.org.cn/project/${project.id}/settings/permissions`
	vars[`PROJECT_PERMISSIONS_FLINK`] =
		`[Permissions settings](https://bbsmc.org.cn/project/${project.id}/settings/permissions)`
	vars[`PROJECT_MONETIZATION_SETTINGS_LINK`] = `https://bbsmc.org.cn/project/${project.id}/settings`
	vars[`PROJECT_MONETIZATION_SETTINGS_FLINK`] =
		`[Monetization settings](https://bbsmc.org.cn/project/${project.id}/settings)`
