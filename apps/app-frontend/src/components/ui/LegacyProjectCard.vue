<script setup>
import { DownloadIcon, HeartIcon, TagIcon } from '@bbsmc/assets'
import { Avatar, FormattedTag, TagItem, useCompactNumber } from '@bbsmc/ui'
		...
		<div
			...
			:style="{
				...
				'background-image': `url(${
					...
					project.gallery[0] ??
					'https://launcher-files.bbsmc.org.cn/assets/maze-bg.png'
				})`,
			}"
		>
			<div
