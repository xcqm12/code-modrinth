...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Bbsmc App cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Bbsmc App',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Bbsmc App after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Bbsmc App cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Make sure you are using the Microsoft account that owns Minecraft. See <a href="https://support.bbsmc.org.cn/en/articles/9409136-finding-the-right-xbox-account">Finding the right Xbox account</a> for help',
			'Try signing in to Bbsmc App again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Bbsmc App could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Bbsmc App and try signing in again',
			'Check that your internet connection is working',
			'Allow Bbsmc App through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Bbsmc App recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
