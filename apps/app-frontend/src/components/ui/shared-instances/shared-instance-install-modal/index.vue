					...
					<p class="m-0">
						<IntlFormatted :message-id="messages.reportDescription">
							<template #rules-link="{ children }">
								<AutoLink class="text-link hover:underline" to="https://bbsmc.org.cn/legal/rules">
									<component :is="() => children" />
								</AutoLink>
							</template>
							<template #terms-link="{ children }">
								<AutoLink class="text-link hover:underline" to="https://bbsmc.org.cn/legal/terms">
									<component :is="() => children" />
								</AutoLink>
							</template>
						</IntlFormatted>
						...
						<li>
							<IntlFormatted :message-id="messages.supportAndBugReports">
								<template #support-link="{ children }">
									<AutoLink class="text-link hover:underline" to="https://support.bbsmc.org.cn">
										<component :is="() => children" />
									</AutoLink>
								</template>
						...
						<li>
							<IntlFormatted :message-id="messages.legalClaims">
								<template #copyright-link="{ children }">
									<AutoLink
										class="text-link hover:underline"
										to="https://bbsmc.org.cn/legal/copyright"
									>
										<component :is="() => children" />
									</AutoLink>
								</template>
