...
const supportLink = ref('https://support.bbsmc.org.cn')
const metadata = ref({})
...
defineExpose({
	async show(errorVal, context, canClose = true, source = null) {
		...
		if (errorVal.message && errorVal.message.includes('Minecraft authentication error:')) {
			...
			supportLink.value =
				'https://support.bbsmc.org.cn/en/articles/9038231-minecraft-sign-in-issues'
			...
			supportLink.value = 'https://support.bbsmc.org.cn'
			...
			title.value = 'Error initializing Bbsmc App'
			...
			<div class="markdown-body">
				<template v-if="errorType === 'minecraft_auth'">
					<template v-if="metadata.network">
						...
						<p>
							It looks like there were issues with the Bbsmc App connecting to Microsoft's
							...
							<a
								href="https://support.bbsmc.org.cn/en/articles/9038231-minecraft-sign-in-issues#h_e71a5f805f"
							>
								our support article
							</a>
							to troubleshoot.
					...
					<template v-else-if="metadata.hostsFile">
						<h3>Network issues</h3>
						<p>
							The Bbsmc App tried to connect to Microsoft / Xbox / Minecraft services, but the
							remote server rejected the connection. This may indicate that these services are
							blocked by the hosts file. Please visit
							<a
								href="https://support.bbsmc.org.cn/en/articles/9038231-minecraft-sign-in-issues#h_d694a29256"
							>
								our support article
							</a>
				...
				<template v-if="errorType === 'directory_move'">
					<template v-if="metadata.readOnly">
						...
						<p>
							It looks like the Bbsmc App is unable to write to the directory you selected.
					...
					<template v-else>
						<p>
							The Bbsmc App is unable to migrate to the new directory you selected. Please
				...
				<template v-else-if="errorType === 'state_init'">
					<p>
						Bbsmc App failed to load correctly. This may be because of a corrupted file, or
				...
				<template v-else-if="errorType === 'no_loader_version'">
					<p>The Bbsmc App failed to find the loader version for this instance.</p>
