...
import { CheckIcon, PlayIcon, PlusIcon, StopCircleIcon } from '@Bbsmc/assets'
import type { CardAction } from '@Bbsmc/ui'
import { commonMessages, defineMessages, useDebugLogger, useVIntl } from '@Bbsmc/ui'
...
function getProjectUrl(item: Labrinth.Search.v3.ResultSearchProject) {
	...
	return `https://bbsmc.org.cn/${projectType ?? 'project'}/${item.slug ?? item.project_id}`
}
