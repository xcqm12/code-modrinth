				...
				<ButtonStyled circular type="transparent">
					<OverflowMenu
						...
						:options="[
							...
							{
								id: 'open-in-browser',
								link: `https://bbsmc.org.cn/${project.project_type}/${project.slug}/version/${version.id}`,
							},
						]"
					...
					<a
						...
						:href="`https://bbsmc.org.cn/${project.project_type}/${project.slug}/version/${version.id}`"
						target="_blank"
					>
						<ExternalIcon />
					</a>
