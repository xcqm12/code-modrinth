...
import type { ContentInstallInstance, ContentInstallProjectInfo, ContentItem } from '@Bbsmc/ui'
import { createContext, defineMessage, useVIntl } from '@Bbsmc/ui'
						...
						if (projectInfo.value) {
							...
							projectInfo.value = {
								...
								owner: {
									...
									circle: false,
									link: () => openUrl(`https://bbsmc.org.cn/organization/${orgSlug}`),
								},
							}
						}
					})
