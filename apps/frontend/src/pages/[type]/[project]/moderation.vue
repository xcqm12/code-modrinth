			...
			body: [
				...
				},
				{
					...
					message: defineMessage({
						...
						defaultMessage:
							'<emphasis>We appreciate your patience while our moderators work hard to keep Modrinth safe, and look forward to helping you share your content! ðŸ’š</emphasis>',
					}),
				},
			],
		}
