<template>
	...
	>
		...
		>
			...
			>
				<img
					src="https://cdn.bbsmc.org.cn/servers/panel-right-dark.webp"
					alt=""
					aria-hidden="true"
			...
			>
				...
				>
					<img
						src="https://cdn.bbsmc.org.cn/servers/bigrinth.webp"
						alt=""
						aria-hidden="true"
		...
		>
			...
			<div class="relative mx-auto flex w-full max-w-7xl flex-col gap-8">
				...
				<img
					src="https://cdn.bbsmc.org.cn/servers/excitement.webp"
					alt=""
				...
				<div class="relative">
					<img
						src="https://cdn.bbsmc.org.cn/servers/installation-dark.webp"
						alt=""
		...
		>
			...
			<div class="relative mx-auto flex w-full max-w-7xl flex-col gap-8">
				...
				<img
					src="https://cdn.bbsmc.org.cn/servers/waving.webp"
					alt=""
				...
				<div class="grid grid-cols-1 gap-9 lg:grid-cols-2">
					...
					>
						...
						<img
							src="https://cdn.bbsmc.org.cn/servers/content-dark.webp"
							alt=""
...
const outOfStockUrl = 'https://discord.bbsmc.org.cn'
