...
import { injectmodrinthClient, provideUserProfile, UserProfilePageLayout } from '@bbsmc/ui'
...
useSeoMeta({
	...
	ogImage: () => prefetchedUser?.avatar_url ?? 'https://cdn.bbsmc.org.cn/placeholder.png',
})
