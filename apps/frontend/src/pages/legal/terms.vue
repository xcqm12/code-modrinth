<template>
	<div class="markdown-body">
		...
		<p>
			...
			api.bbsmc.org.cn, or the modrinth App, including any content, functionality and services
			offered on or through www.bbsmc.org.cn, api.bbsmc.org.cn, or the modrinth App (the "Service"),
