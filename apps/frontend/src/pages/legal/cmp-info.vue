<template>
	<div class="markdown-body">
		...
		<p>
			...
			<a href="mailto:support@bbsmc.org.cn">support@bbsmc.org.cn</a> if you have any questions!
		</p>
		<p>
		...
		<p>
			...
			banned from using Bbsmc's services.
		</p>
		<p>
			You can view your page views and project downloads in your
			<a href="https://bbsmc.org.cn/dashboard/analytics">analytics dashboard</a>.
		</p>
		...
		<p>
			...
			including our
			<a href="https://github.com/xcqm12/code-Bbsmc/blob/main/apps/labrinth/src/queue/payouts">
				revenue distribution system</a
			>. We also have an
			<a href="https://api.bbsmc.org.cn/v3/payout/platform_revenue">API route</a>
			to query the exact daily advertising revenue for the site - so far, creators on Bbsmc have
		...
		<small
			>Bbsmc's total ad revenue in the previous 5 days, for the entire dataset, use the
			aforementioned
			<a href="https://api.bbsmc.org.cn/v3/payout/platform_revenue">API route</a>.</small
		>
	</div>
</template>

<script lang="ts" setup>
import { DatePicker, injectBbsmcClient, useFormatDateTime, useFormatMoney } from '@Bbsmc/ui'
