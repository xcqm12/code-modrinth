...
const footerLinks: {
	...
	},
	{
		...
		links: [
			{
				href: 'https://support.bbsmc.org.cn',
				label: defineMessage({
			...
			{
				href: 'https://translate.bbsmc.org.cn',
				label: defineMessage({
			...
			{
				href: 'https://docs.bbsmc.org.cn/api/',
				label: defineMessage({
