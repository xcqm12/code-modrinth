...
import { CheckIcon, MailIcon } from '@Bbsmc/assets'
import { ButtonStyled, defineMessages, injectBbsmcClient, useVIntl } from '@Bbsmc/ui'
...
const messages = defineMessages({
	tooltipSubscribe: {
		...
		defaultMessage: 'Subscribe to the Bbsmc newsletter',
	},
	subscribe: {
