	...
	<StyledDoc title="Payment Statement">
			...
			<div class="flex items-start gap-8">
				<div class="flex-1">
					...
					<Text class="m-0 mt-2 text-sm text-secondary">
						<VLink href="mailto:support@bbsmc.org.cn" class="text-blue no-underline">
		...
		<Section class="mb-8">
			...
			<Text class="m-0 text-sm leading-relaxed text-secondary">
				This payout reflects the creator's earnings from their activity on the Bbsmc platform.
