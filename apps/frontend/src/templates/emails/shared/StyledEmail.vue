...
const socialLinks = Object.freeze<readonly SocialLink[]>([
	{
		href: 'https://discord.bbsmc.org.cn',
		alt: 'Discord',
		src: 'https://cdn-raw.bbsmc.org.cn/email/discord.png',
	},
	{
		href: 'https://bsky.app/profile/bbsmc.org.cn',
		alt: 'Bluesky',
		...
		<Section class="bg-bg pb-4 pl-4 pr-4 pt-4">
			<Container class="max-w-[600px]">
				<Row>
					<Column>
						<Img
							src="https://cdn.bbsmc.org.cn/email/f740e2decee8764a4629bff677a284f9.png"
							width="29"
							alt=""
							class="block h-auto"
						/>
		...
		>
			...
			<Text class="text-2xs text-muted mt-0">
				...
				<!-- <span class="block break-words">
					...
					https://bbsmc.org.cn/settings/notifications
				</span> -->
			</Text>
		</Section>
	</StyledTemplate>
