...
<template>
	<StyledEmail
		...
		:manual-links="[
			{ link: 'https://bbsmc.org.cn/dashboard/revenue', label: 'Revenue dashboard' },
	...
	>
		...
		<Section class="mb-4 mt-4">
			<Button
				href="https://bbsmc.org.cn/dashboard/revenue"
				target="_blank"
		...
		<Text class="text-base">Thank you for being a creator on Bbsmc!</Text>
	</StyledEmail>
</template>
