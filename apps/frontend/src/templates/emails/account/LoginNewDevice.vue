...
<template>
	<StyledEmail
		...
		:manual-links="[{ link: 'https://support.bbsmc.org.cn', label: 'Support Portal' }]"
	>
					...
					<Row class="mb-2 mt-0">
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.bbsmc.org.cn/email/earth.png"
							/>
						</Column>
						<Column>
					...
					<Row class="mb-2">
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.bbsmc.org.cn/email/monitor-smartphone.png"
							/>
						</Column>
						<Column>
					...
					<Row>
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.bbsmc.org.cn/email/clock.png"
							/>
						</Column>
						<Column>
