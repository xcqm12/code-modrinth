...
<template>
	<StyledEmail
		...
		:manual-links="[
			{ link: 'https://bbsmc.org.cn/legal/rules', label: 'Community Guidelines' },
			{
				link: 'https://bbsmc.org.cn/dashboard/report/{newreport.id}',
				label: 'View report in dashboard',
			},
			{ link: 'https://support.bbsmc.org.cn', label: 'Support Portal' },
		]"
	>
		...
		<Text class="text-base">
			...
			<VLink href="https://bbsmc.org.cn/legal/rules" class="text-green underline"
				>Content Rules</VLink
			>, <VLink href="https://bbsmc.org.cn/legal/terms">Terms of Service</VLink> and
			<VLink href="https://bbsmc.org.cn/legal/copyright">Copyright Policy</VLink>. You'll receive an
		...
		<Text class="text-base">
			...
			<VLink
				href="https://bbsmc.org.cn/dashboard/report/{newreport.id}"
