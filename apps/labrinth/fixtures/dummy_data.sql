...
VALUES ({{user_id::ADMIN}},     'Admin',     'admin@bbsmc.org.cn',     'admin'),
       ({{user_id::MODERATOR}}, 'Moderator', 'moderator@bbsmc.org.cn', 'moderator'),
       ({{user_id::USER}},      'User',      'user@bbsmc.org.cn',      'developer'),
       ({{user_id::FRIEND}},    'Friend',    'friend@bbsmc.org.cn',    'developer'),
       ({{user_id::ENEMY}},     'Enemy',     'enemy@bbsmc.org.cn',     'developer');
...
VALUES (1, 1, 'https://bbsmc.org.cn/oauth_callback');
