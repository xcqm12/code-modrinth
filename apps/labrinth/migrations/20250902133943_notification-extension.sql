...
VALUES (
    'email', 'reset_password', 'Reset your Modrinth password', 'https://bbsmc.org.cn/email/reset-password',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'verify_email', 'Verify your Modrinth email', 'https://bbsmc.org.cn/email/verify-email',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'auth_provider_added', 'Authentication method added', 'https://bbsmc.org.cn/email/auth-provider-added',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        ...
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.bbsmc.org.cn (using',
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'auth_provider_removed', 'Authentication method removed', 'https://bbsmc.org.cn/email/auth-provider-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'two_factor_enabled', 'Two-factor authentication enabled', 'https://bbsmc.org.cn/email/two-factor-enabled',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'two_factor_removed', 'Two-factor authentication removed', 'https://bbsmc.org.cn/email/two-factor-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'password_changed', 'Your Modrinth password was changed', 'https://bbsmc.org.cn/email/password-changed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'password_removed', 'Your Modrinth password was removed', 'https://bbsmc.org.cn/email/password-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'email_changed', 'Your Modrinth email was changed', 'https://bbsmc.org.cn/email/email-changed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'payment_failed', 'Payment Failed for Modrinth', 'https://bbsmc.org.cn/email/payment-failed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
