...
VALUES
	(
		...
		'https://bbsmc.org.cn/_internal/templates/email/server-invited',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'To accept or reject this invitation, open your Modrinth notifications: https://bbsmc.org.cn/dashboard/notifications',
			CHR(10),
			CHR(10),
			'If you were not expecting this invitation, contact the server owner or reach out to Modrinth Support at https://support.bbsmc.org.cn'
		)
	);
