...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/payout-available',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View your revenue dashboard: https://bbsmc.org.cn/dashboard/revenue',
			CHR(10),
			CHR(10),
			'If you have any questions about the creator rewards program, please contact support through the Support Portal at https://support.bbsmc.org.cn/ or by replying to this email.',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/personal-access-token-created',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'Support Portal: https://support.bbsmc.org.cn/'
		)
	);
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/moderation-thread-message-received',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			'Your project''s moderation thread: https://bbsmc.org.cn/project/{project.id}/moderation',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/report-updated',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/report-submitted',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'If you have any additional information about this report, you can view it here: https://bbsmc.org.cn/dashboard/report/{newreport.id}',
			CHR(10),
			CHR(10),
			'Thank you for helping keep Modrinth safe and welcoming for everyone.'
		)
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/project-approved',
		CONCAT(
			...
			CHR(10),
			CHR(10),
			'View your project here: https://bbsmc.org.cn/project/{project.id}',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/project-status-updated-neutral',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View your project here: https://bbsmc.org.cn/project/{project.id}/moderation',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://bbsmc.org.cn/email/project-ownership-transferred',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View the project here: https://bbsmc.org.cn/project/{project.id}',
			CHR(10),
			CHR(10),
