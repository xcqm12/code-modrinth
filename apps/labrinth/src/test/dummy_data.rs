...
impl TestFile {
    pub fn build_random_jar() -> Self {
        ...
        let fabric_mod_json = serde_json::json!({
            ...
            "contact": {
              "homepage": "https://www.bbsmc.org.cn",
              "sources": "https://www.bbsmc.org.cn",
              "issues": "https://www.bbsmc.org.cn"
            },
            ...
            "files": [
                {
                    ...
                    "downloads": [
                        "https://cdn.bbsmc.org.cn/data/PRN43VSY/versions/uNgEPb10/animatica-0.6%2B1.20.jar"
                    ],
                    "fileSize": 69810
                }
            ],
