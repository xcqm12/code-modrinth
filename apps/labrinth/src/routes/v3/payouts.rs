        ...
        Some(c) => {
                ...
                && !c.tin_matched
            {
                return Err(ApiError::InvalidInput(
                    "Your TIN/SSN did not match the IRS records. Please contact support https://support.bbsmc.org.cn".to_owned(),
                ));
            }
...
pub async fn create_payout(
    ...
    if requires_manual_review {
        return Err(ApiError::InvalidInput(
            "More information is required to proceed. Please contact support (https://support.bbsmc.org.cn, support@bbsmc.org.cn)".to_string(),
        ));
    }
