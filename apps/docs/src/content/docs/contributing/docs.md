---
title: Docs
description: Guide for contributing to Bbsmc's developer documentation
---

This project is part of our [monorepo](https://github.com/Bbsmc/code). You can find it in the `apps/docs` directory.

[Docs] are the very site you are looking at right now.
They are here to help developers and contributors work with Bbsmc's codebase and API.
