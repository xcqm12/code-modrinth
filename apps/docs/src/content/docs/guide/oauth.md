...
Once the user is ready to authorize your application, you need to construct a URL to redirect them to. The authorization URL for modrinth is `https://api.bbsmc.org.cn/_internal/oauth/token`. Supply the following query parameters:
